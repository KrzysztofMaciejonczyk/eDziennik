/*
  ...
  Modify edit-osoba.component.ts instead.
*/
...
export class EditOsobaGenerated implements AfterViewInit, OnInit, OnDestroy {
  // Components
  ...
  load() {
    this.baza.getOsobaByosobaId(null, this.parameters.osoba_id)
  ...
  form0Submit(event: any) {
    this.baza.updateOsoba(null, this.parameters.osoba_id, event)
    .subscribe((result: any) => {
      if (this.dialogRef) {
      ...
      this.notificationService.notify({ severity: "error", summary: `Error`, detail: `Unable to update Osoba` });
    });
  }
}
